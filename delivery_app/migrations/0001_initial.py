# Generated by Django 5.1.3 on 2024-12-01 11:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_role', models.CharField(choices=[('courier', 'courier'), ('client', 'client'), ('owner', 'owner')], default='client', max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='delivery_app.cart')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_orders', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='current_orders', to='delivery_app.order')),
            ],
        ),
        migrations.CreateModel(
            name='CarItem',
            fields=[
                ...
                ('cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='delivery_app.cart')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('store', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='combo_store', to='delivery_app.store')),
            ],
        ),
        migrations.AddField(
            model_name='product',
            name='store',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_store', to='delivery_app.store'),
        ),
        migrations.CreateModel(
            name='Contact',
            fields=[
                ...
                ('store', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contacts', to='delivery_app.store')),
            ],
        ),
        migrations.CreateModel(
            name='StoreReview',
            fields=[
                ...
                ('store', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='delivery_app.store')),
            ],
        ),
    ]
